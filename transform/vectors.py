...
class Vector2(object):
    ...
    def cross(self,other):
        ...
        :param other: second vector
        :return: cross product of two vectors (in case of vector2 it is a real number, not a vector!)
        '''
...
class Vector4(object):
    ...
    @staticmethod
    def make_vector(item: Union[list[Union[int, float]], Vector4]):
        if isinstance(item, Vector4):
            return item
        if isinstance(item, list):
